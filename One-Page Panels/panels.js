...
var nav_left = doc.getElementsByClassName('js-left');
var nav_right = doc.getElementsByClassName('js-right');
var nav_down = doc.getElementsByClassName('js-down');
...
function setPanelAndZoom(e) {
  pos_x = -e.target.getAttribute('data-x-pos'), pos_y = e.target.getAttribute('data-y-pos');
  setPos();
  zoomIn();
}
